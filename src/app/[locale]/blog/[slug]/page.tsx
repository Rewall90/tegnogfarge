  ...
  if (!post) {
    return (
      <main className="container mx-auto px-4 py-8">
        ...
        <Link href={locale === 'no' ? '/blog' : `/${locale}/blog`} className="text-blue-500 hover:underline">← Tilbake til blogg</Link>
      </main>
    );
  }
  ...
  return (
    <>
      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl">
        <Link href={locale === 'no' ? '/blog' : `/${locale}/blog`} className="text-blue-500 hover:underline mb-4 inline-block">
          ← Tilbake til blogg
        </Link>
                ...
                <div className="flex ml-4">
                  ...
                  <div className="flex gap-2 flex-wrap">
                    {post.categories.map((category: CategoryType) => (
                      <Link
                        key={category._id}
                        href={locale === 'no' ? `/blog/category/${category.slug.current}` : `/${locale}/blog/category/${category.slug.current}`}
