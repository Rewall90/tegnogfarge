...
export default async function ContentRemovalPolicyPage({ params }: PageProps) {
  ...
  const breadcrumbItems = [
    ...
    { label: 'Fjerning av innhold', href: locale === 'no' ? '/fjerning-av-innhold' : `/${locale}/fjerning-av-innhold`, active: true }
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div>
            ...
            <p className="text-lg text-gray-600 mb-4">
                Dersom du ser noe på nettsiden vår som du mener vi ikke har rett til å bruke – kanskje du selv eier det – kan du <Link href={locale === 'no' ? '/kontakt' : `/${locale}/kontakt`} className="text-link-orange hover:underline">kontakte oss via kontaktskjemaet</Link>. Vennligst inkluder følgende informasjon i meldingen din:
            </p>
            ...
            <p className="text-lg text-gray-600">
                Lurer du på noe? <Link href={locale === 'no' ? '/kontakt' : `/${locale}/kontakt`} className="text-link-orange hover:underline">Ta kontakt med oss</Link>, så svarer vi så fort vi kan.
            </p>
        </div>
      </div>
    </PageLayout>
