...
export async function generateMetadata({ params }: PageProps) {
  ...
  // Redirect Norwegian to /personvernerklaering
  if (locale === 'no') {
    return {};
  }

  const t = privacyTranslations[locale as Locale] || privacyTranslations.sv;
  const pathname = '/sekretesspolicy';
  ...
  return {
    ...
    other: {
      'privacy-policy': `${baseUrl}/sekretesspolicy`,
      'cookie-policy': `${baseUrl}/sekretesspolicy`,
    },
  };
}

export default async function SekretesspolicyPage({ params }: PageProps) {
  const { locale } = await params;
  ...
  const breadcrumbItems = [
    ...
    { label: t.breadcrumb.privacy, href: `/${locale}/sekretesspolicy`, active: true }
  ];
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": t.heading,
            "description": t.metadata.description,
            "url": "https://tegnogfarge.no/sekretesspolicy",
            ...
            "about": [
              ...
              {
                "@type": "Thing",
                "name": "Swedish Privacy Law",
                "description": "Compliance with Swedish data protection regulations"
              }
            ]
          })
        }}
