        ...
        <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md">
          ...
          <section className="mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-6">
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <h3 className="text-xl font-medium text-center">Petter Olsen</h3>
                <p className="text-gray-600 text-center mb-3">Grunnlegger & Kreativ Leder</p>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <div className="w-32 h-32 bg-gray-200 rounded-full mx-auto mb-4"></div>
                <h3 className="text-xl font-medium text-center">Anna Hansen</h3>
                <p className="text-gray-600 text-center mb-3">Innholdsskaper</p>
                <p className="text-gray-700">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4">
              <li className="mb-2">Tilby høykvalitets fargeleggingsressurser for alle aldersgrupper</li>
              <li className="mb-2">Dele kunnskap og teknikker for å forbedre kreative ferdigheter</li>
              <li className="mb-2">Bygge et støttende fellesskap for kreative entusiaster</li>
              <li className="mb-2">Fremme fargelegging som en måte å redusere stress og fremme mindfulness</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <p className="mb-2"><strong>E-post:</strong> kontakt@eksempel.no</p>
              <p className="mb-2"><strong>Telefon:</strong> +47 123 45 678</p>
              <p><strong>Adresse:</strong> Eksempelgata 123, 0000 Oslo, Norge</p>
            </div>
          </section>
        </div>
      </main>
