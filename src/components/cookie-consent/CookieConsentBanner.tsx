    ...
    <div className="fixed bottom-4 left-4 z-50 p-4 bg-white border border-gray-200 shadow-xl rounded-lg max-w-sm sm:max-w-md animate-slide-up">
      <div className="space-y-4">
          ...
          <div className="flex flex-col gap-2">
            <button
              onClick={acceptAll}
              className="px-4 py-2 text-sm font-medium text-black bg-[#FF6F59] rounded-md hover:bg-[#e55a43] focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors duration-200"
